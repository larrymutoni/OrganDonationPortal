                        ...
                        <div class="donate-form">
                            <form>
                                <div class="control-group">
                                    <input type="text" class="form-control" placeholder="Hospital ID" required="required" />
                                </div>
                                <div class="control-group">
                            ...
                            <p></p>
                            <div>
                                <a href="/hospitalRegister"><button class="btn btn-custom" type="text">Click Here --- To Register(Hospitals Only)</button></a>
                            </div>
                        </div>
                    </div>
                </div>
